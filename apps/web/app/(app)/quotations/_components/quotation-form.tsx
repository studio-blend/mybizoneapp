...
export function QuotationForm({ products, customers }: Props) {
  ...
  function updateLine(id: number, patch: Partial<LineItem>) {
    setLines((prev) =>
      prev.map((l) => {
        ...
        // Auto-fill unitPrice when product changes
  ...
  async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    toast({ title: 'Quotation created', description: result.data.quoteNo });
      ...
      <form onSubmit={onSubmit}>
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Textarea id="notes" name="notes" maxLength={500} placeholder="Terms, remarks…" />
          </div>
