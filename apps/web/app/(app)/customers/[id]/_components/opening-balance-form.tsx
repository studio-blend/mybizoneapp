...
import { setCustomerOpeningBalanceAction } from '../../actions';
...
export function OpeningBalanceForm({ customerId, financialYear, current, notes }: Props) {
  ...
  async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    e.preventDefault();
    setPending(true);
    const result = await setCustomerOpeningBalanceAction({
      customerId,
      financialYear,
      amount,
      notes: noteText,
